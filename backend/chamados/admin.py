...
@admin.register(EmailIngestionConfig)
class EmailIngestionConfigAdmin(admin.ModelAdmin):
    list_display = ["email", "imap_host", "is_active", "total_processed", "last_checked_at"]
    readonly_fields = ["last_checked_at", "last_error", "total_processed", "created_at", "updated_at", "encrypted_password"]
