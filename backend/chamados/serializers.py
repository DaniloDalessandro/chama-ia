...
from .models import Chamado, AnexoChamado, HistoricoChamado, ComentarioChamado, Notification, WebhookConfig, EmailIngestionConfig
...
# ============================================
# Serializer de Configuracao de Email (ingestao de chamados)
# ============================================

class EmailIngestionConfigSerializer(serializers.ModelSerializer):
    """Serializer para configuracao da caixa de email de chamados."""
    ...
    def create(self, validated_data):
        """Cria configuracao com senha criptografada."""
        password = validated_data.pop("password", None)
        instance = EmailIngestionConfig(**validated_data)
        if password:
    ...
    def update(self, instance, validated_data):
        """Atualiza configuracao, criptografando senha se fornecida."""
        password = validated_data.pop("password", None)
