...
from .views import (
    ...
    EmailIngestionConfigView,
    EmailIngestionCheckNowView,
)
...
urlpatterns = [
    ...
    path("email-config/", EmailIngestionConfigView.as_view(), name="email-config"),
    path("email-config", EmailIngestionConfigView.as_view(), name="email-config-no-slash"),
    path("email-config/verificar-agora/", EmailIngestionCheckNowView.as_view(), name="email-config-check-now"),
    path("email-config/verificar-agora", EmailIngestionCheckNowView.as_view(), name="email-config-check-now-no-slash"),
